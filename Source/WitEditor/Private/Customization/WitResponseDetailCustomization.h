...
/**
 * Apples a details customization to the 'Response' category of the UWitVoiceService class. This adds an additional
 * 'Understanding' section that allows us to enter text queries and send them to Wit.ai in order to see the response
 */
class FWitResponseDetailCustomization final : public IDetailCustomization
{
public:
