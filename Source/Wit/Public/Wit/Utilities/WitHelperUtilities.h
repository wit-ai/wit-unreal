...
public:
	 ...
	 */
	static USoundWave* CreateSoundWaveFromRawData(const uint8* RawData, const int32 RawDataSize, const EWitRequestAudioFormat AudioFormat, const bool bUseStreaming);
